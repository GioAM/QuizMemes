...
class Jogo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        perguntas.add(Pergunta("Quem Dilma está saudando?","a mandioca","o Lula","a tapioca",R.id.botao1.toString(), resources.getIdentifier("dilma","mipmap",packageName),som.load(gerenciadorDeAssets.openFd("dilma.mp3"),1),4000))
